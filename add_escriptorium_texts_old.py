...
##        # the internal name in eScriptorium for CDH_AOCP_PERSIAN is "persian_texts":
##        # https://escriptorium.openiti.org/project/persian_texts/documents/
...
##                #continue
##                layer = "kraken:all_arabic_scripts"
...
def add_eScriptorium_files(meta_fp, download_folder, dest_folder,
                           ...
                           include_image_name=True, reorder_pages=False,
                           skip_orphan_lines=True, reconvert=False, redownload=False,
                           main_text_region="Main", add_languages=["per"]):
    """Add files from eScriptorium to barzakh
...
if __name__ == "__main__":
    ...
    add_eScriptorium_files(meta_fp, download_folder, dest_folder,
                           reconvert=False,               # convert even if the file is already in the corpus or barzakh
                           first_row=561, last_row=578,   # from row X to row Y in the metadata spreadsheet
